        ...
        <div className="container mx-auto px-6 py-12">
            ...
            <div className="text-center mb-10">
                ...
                <p className="mt-2 text-pm-gray-light max-w-2xl mx-auto">
                    Explore the characters, factions, and events of The City
                </p>
            </div>

            {/* Quick Nav */}
            <div className="flex justify-center gap-4 mb-10">
                <a href="#characters" className="text-pm-gray-light hover:text-pm-gold">Characters</a>
                <span className="text-pm-gray-dark">|</span>
                <a href="#factions" className="text-pm-gray-light hover:text-pm-gold">Factions</a>
                <span className="text-pm-gray-dark">|</span>
                <a href="#events" className="text-pm-gray-light hover:text-pm-gold">Events</a>
            </div>

            {/* Characters Section */}
            <section id="characters" className="mb-16">
                <h2 className="text-2xl font-serif font-bold text-white mb-6 flex items-center gap-2">
                    <span>👥</span> Key Characters
                </h2>
            ...
            <section id="factions" className="mb-16">
                <h2 className="text-2xl font-serif font-bold text-white mb-6 flex items-center gap-2">
                    <span>🏛️</span> Factions & Organizations
                </h2>
                    ...
                    {FACTIONS.map((faction) => (
                        ...
                        >
                            ...
                            <div className="border-t border-pm-gray-dark pt-3 mt-3">
                                <p className="text-xs text-pm-gold mb-2">Philosophy:</p>
                            ...
                            <div className="mt-3">
                                <p className="text-xs text-pm-gray-light/70">
                                    Key Members: {faction.keyMembers.slice(0, 4).join(', ')}
                                ...
                                <div className="flex-1">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <span className={`text-xs px-2 py-0.5 rounded ${event.spoilerLevel === 1 ? 'bg-green-600/30 text-green-400' :
                                            ...
                                            {event.spoilerLevel === 1 ? 'Early Story' :
                                                event.spoilerLevel === 2 ? 'Mid Story' : 'Endgame'}
                                        </span>
                                    </div>
            ...
            <section className="bg-gradient-to-r from-pm-gold/20 to-pm-red/20 border border-pm-gold/50 rounded-lg p-6 text-center">
                <h3 className="text-xl font-serif font-bold text-white mb-2">
                    Have Questions About the Lore?
                </h3>
                <p className="text-pm-gray-light mb-4">
                    Use our AI assistant to explore the story in more depth
                </p>
                <Link
